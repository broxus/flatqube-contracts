...
describe(`Test beneficiary fee (dex-pair)`, function () {
  ...
  describe("Deposit multiple coins to DexPair", async function () {
  ...
  describe("Direct deposit to DexPair", async function () {
  ...
  describe("Direct exchange with DexPair", function () {
