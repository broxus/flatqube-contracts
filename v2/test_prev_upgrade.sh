...
npx locklift run --network local --disable-build --script v2/scripts/upgrade-DexGasValues.ts

echo "____________________________________________________________________";
echo "prev root -> root";
npx locklift run --network local --disable-build --script v2/scripts/update-dexRoot.ts --old_contract='DexRootPrev' --new_contract='DexRoot'

echo "____________________________________________________________________";
echo "prev dex account -> dex account";
npx locklift run --network local --disable-build --script v2/scripts/update-dexAccount.ts --old_contract_name='DexAccountPrev' --new_contract_name='DexAccount'

echo "____________________________________________________________________";
echo "prev vault -> vault";
npx locklift run --network local --disable-build --script v2/scripts/update-dexVault.ts --old_contract='DexVaultPrev' --new_contract='DexVault'
...
npx locklift run --network local --disable-build --script v2/scripts/35-upgrade-pair.ts --roots='["6-0", "18-0"]' --old_contract_name='DexStablePairPrev' --new_contract_name='DexStablePair' --pool_type=2

echo "____________________________________________________________________";
echo "prev stable pool -> stable pool";
npx locklift run --network local --disable-build --script v2/scripts/35-upgrade-pool.ts --roots='["6-0", "9-0", "18-0"]' --old_contract_name='DexStablePoolPrev' --new_contract_name='DexStablePool'
