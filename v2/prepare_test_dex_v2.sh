...
npx locklift run $PARAMS --script v2/scripts/98-mint-test-tokens-to.ts --to='0:33478651d9c7b44c1b45c2dfe85edf7a5d24692f5222f0a25c176b1abfd95e51' --mints='[{"amount":1000000,"token":"foo"},{"amount":1000000,"token":"bar"},{"amount":4000000,"token":"qwe"},{"amount":1000000,"token":"tst"}]'
