...
async function main() {
    ...
    const weverRoot = migration.loadContract('TokenRootUpgradeable', 'WEVERRoot').address;
    const weverVault = migration.loadContract('TestWeverVault', 'WEVERVault').address;
