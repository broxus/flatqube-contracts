...
# update pairs
npx locklift test $NO_TRACE --tests test/35-upgrade-pair.js --left='bar' --right='qwe' --old_contract_name='DexPair' --new_contract_name='TestOracleDexPair'
npx locklift test $NO_TRACE --tests test/35-upgrade-pair.js --left='foo' --right='qwe' --old_contract_name='DexPair' --new_contract_name='TestOracleDexPair'
npx locklift test $NO_TRACE --tests test/35-upgrade-pair.js --left='foo' --right='tst' --old_contract_name='DexPair' --new_contract_name='TestOracleDexPair'
npx locklift test $NO_TRACE --tests test/35-upgrade-pair.js --left='bar' --right='tst' --old_contract_name='DexPair' --new_contract_name='TestOracleDexPair'
