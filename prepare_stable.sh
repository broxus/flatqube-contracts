...
npx locklift run $NO_TRACE --script scripts/5-deploy-test-pair.js --pairs='[["coin", "foo"]]' --contract_name='DexPair'
npx locklift run $NO_TRACE --script scripts/5-deploy-test-pair.js --pairs='[["coin", "bar"]]' --contract_name='DexPair'
npx locklift run $NO_TRACE --script scripts/5-deploy-test-pair.js --pairs='[["qwe", "coin"]]' --contract_name='DexPair'
npx locklift run $NO_TRACE --script scripts/5-deploy-test-pair.js --pairs='[["qwe", "tst"]]' --contract_name='DexPair'
npx locklift run $NO_TRACE --script scripts/5-deploy-test-pair.js --pairs='[["coin", "tst"]]' --contract_name='DexPair'
...
npx locklift test $NO_TRACE --tests test/09-add-pair-test.js --left='coin' --right='foo' --account=2 --contract_name='DexPair' --ignore_already_added='true'
npx locklift test $NO_TRACE --tests test/09-add-pair-test.js --left='coin' --right='bar' --account=2 --contract_name='DexPair' --ignore_already_added='true'
npx locklift test $NO_TRACE --tests test/09-add-pair-test.js --left='qwe' --right='coin' --account=2 --contract_name='DexPair' --ignore_already_added='true'
...
npx locklift test $NO_TRACE --tests test/09-add-pair-test.js --left='coin' --right='tst' --account=2 --contract_name='DexPair' --ignore_already_added='true'
...
npx locklift test $NO_TRACE --tests test/12-pair-deposit-liquidity.js --left_token_id 'coin' --right_token_id 'foo' --left_amount '15497736' --right_amount '5685522' --auto_change 'true' --contract_name='DexPair'
npx locklift test $NO_TRACE --tests test/12-pair-deposit-liquidity.js --left_token_id 'coin' --right_token_id 'bar' --left_amount '15497736' --right_amount '5685522' --auto_change 'true' --contract_name='DexPair'
npx locklift test $NO_TRACE --tests test/12-pair-deposit-liquidity.js --left_token_id 'qwe' --right_token_id 'coin' --left_amount '39.3109' --right_amount '4161621' --auto_change 'true' --contract_name='DexPair'
