...
npx locklift run $NO_TRACE --script scripts/1-deploy-vault-and-root.js --pair_contract_name='DexPairPrev' --root_contract_name='DexRoot' --vault_contract_name='DexVault' --account_contract_name='DexAccount'
