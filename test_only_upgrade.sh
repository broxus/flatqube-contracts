...
npx locklift run $DEFAULT_PARAMS --script scripts/update-dexAccounts.js
...
npx locklift test $NO_TRACE --tests test/10-deposit-to-dex-account.js --deposits='[{ "tokenId": "qwe", "amount": 100000000 }]'
...
#TODO
#npx locklift test $NO_TRACE --tests test/30-install-pair-code-v2.js --contract_name='DexStablePair' --pool_type=2
#npx locklift test $DEFAULT_PARAMS --tests test/35-upgrade-pair.js --left='foo' --right='bar' --old_contract_name='DexStablePair' --new_contract_name='DexStablePair' --pool_type=2
...
#TODO
#npx locklift test $NO_TRACE --tests test/30-install-pair-code-v2.js --contract_name='DexPair' --pool_type=1
#npx locklift test $NO_TRACE --tests test/35-upgrade-pair.js --left='foo' --right='bar' --old_contract_name='DexPair' --new_contract_name='DexPair' --pool_type=1
...
echo "pool -> pair";
#TODO
#npx locklift test $DEFAULT_PARAMS --tests test/35-upgrade-pool.js --roots='["foo", "bar"]' --old_contract_name='DexPair' --new_contract_name='DexStablePool' --pool_type=1

echo "____________________________________________________________________";
echo "pair -> pool";
# TODO
#npx locklift test $DEFAULT_PARAMS --tests test/35-upgrade-pair.js --left='foo' --right='qwe' --old_contract_name='DexStablePool' --new_contract_name='DexPair' --pool_type=1
