...
npx locklift test $NO_TRACE --tests test/12-pair-deposit-liquidity.js  --contract_name='DexStablePair' --left_token_id 'foo' --right_token_id 'bar' --left_amount '10000' --right_amount '10000' --auto_change 'true'
