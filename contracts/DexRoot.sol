...
contract DexRoot is DexContractBase, IDexRoot {
    ...
    function upgrade(TvmCell code)
        ...
        onlyOwner
    {
        require(msg.value >= _calcValue(GasValues.getUpgradeRootGas()), DexErrors.VALUE_TOO_LOW);
    ...
    function deployPair(
        ...
        onlyActive
    {
        require(msg.value >= _calcValue(GasValues.getDeployPoolGas(2)), DexErrors.VALUE_TOO_LOW);
        ...
        onlyManagerOrOwner
    {
        ...
        require(msg.value >= _calcValue(GasValues.getDeployPoolGas(rootsCount)), DexErrors.VALUE_TOO_LOW);
