...
library DexGas {
    ...
    uint128 constant DEPLOY_VAULT_MIN_VALUE             = 1.5 ton;
    uint128 constant DEPLOY_LP_TOKEN_ROOT_VALUE         = 5 ton;
    ...
    uint128 constant TRANSFER_REFERRER_FEE_BASE         = 0.4 ton;
    uint128 constant DEPLOY_REFERRER_FEE_EMPTY_WALLET   = 0.1 ton;
    uint128 constant REFERRAL_PROGRAM_CALLBACK          = 0.4 ton;
}
